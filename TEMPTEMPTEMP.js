...
function resizeControls() {
  ...
  iButton.position(x_PIDbuttons, y_inflowSlider + tankSize/2);
  iButton.style('transform', `scale(${scaleFactor})`);
  dButton.position(x_PIDbuttons, y_inflowSlider + tankSize);
...
function drawPIDLines(startX, startY, pPos, iPos, dPos) {
  ...
  line(startX, iPos.y, splitX, iPos.y);
  ...
  drawBox(x_uBox, y_uBox, iPos.height, iPos.width);


  drawSumBlock(pPos.x/0.80, iPos.y, 15);
...
function drawBox(x,y, boxHeight, boxWidth){
